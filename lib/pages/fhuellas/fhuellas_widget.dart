...
import 'fhuellas_model.dart';
export 'fhuellas_model.dart';

class FhuellasWidget extends StatefulWidget {
  const FhuellasWidget({Key? key}) : super(key: key);

  @override
  _FhuellasWidgetState createState() => _FhuellasWidgetState();
}

class _FhuellasWidgetState extends State<FhuellasWidget> {
  late FhuellasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FhuellasModel());
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Image.asset(
                          'assets/images/Opera_Captura_de_pantalla_2023-04-17_173307_huellasfundacion.org.png',
                          width: 200.0,
                          height: 200.0,
                          fit: BoxFit.cover,
                        ),
